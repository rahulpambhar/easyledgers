...
import { getInvoiceNumber, insert, update, getById, get, deletePurchase, cancel, search, download } from "../../controllers/Purchase/purchase";
...
router.post("/delete", verifyJWT, deleteValidator, deletePurchase);
