...
import { getInvoiceNumber, insert, update, getById, get, deleteRN, search, cancel, download } from "../../controllers/Purchase/receiptNote";
...
router.post("/delete", verifyJWT, deleteValidator, deleteRN);
